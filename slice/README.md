...
- Функция append всегда возвращает новый слайс, который может указывать на ту же или новую область памяти. Не забывайте сохранять результат append, если хотите, чтобы изменения отразились.
---
